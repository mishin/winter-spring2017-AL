...
// load in the proper order to satisfy dependency injection
 ...
 angular.module('angular-jwt.jwt', [])
  .service('jwtHelper', ["$window", function($window) {
    ...
    this.isTokenExpired = function(token, offsetSeconds) {
      ...
      // Token expired?
      return !(d.valueOf() > (new Date().valueOf() + (offsetSeconds * 2000)));
    };
  }]);
...
angular.module('angular-jwt.options', [])
 ...
 /**
  * The content from this file was copied from Angular.
  *
  * Angular References:
